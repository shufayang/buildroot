...
s/\<fBcaptoinfo\\fP(1M)/fBcaptoinfo\\fP(1)/
s/\<fBclear\\fP(1)/fBclear\\fP(1)/
s/\<fBcurs_add_wch\\fP(3X)/fBadd_wch\\fP(3NCURSES)/
s/\<fBcurs_add_wchstr\\fP(3X)/fBadd_wchstr\\fP(3NCURSES)/
s/\<fBcurs_addch\\fP(3X)/fBaddch\\fP(3NCURSES)/
s/\<fBcurs_addchstr\\fP(3X)/fBaddchstr\\fP(3NCURSES)/
s/\<fBcurs_addstr\\fP(3X)/fBaddstr\\fP(3NCURSES)/
s/\<fBcurs_addwstr\\fP(3X)/fBaddwstr\\fP(3NCURSES)/
s/\<fBcurs_attr\\fP(3X)/fBattr\\fP(3NCURSES)/
s/\<fBcurs_beep\\fP(3X)/fBbeep\\fP(3NCURSES)/
s/\<fBcurs_bkgd\\fP(3X)/fBbkgd\\fP(3NCURSES)/
s/\<fBcurs_bkgrnd\\fP(3X)/fBbkgrnd\\fP(3NCURSES)/
s/\<fBcurs_border\\fP(3X)/fBborder\\fP(3NCURSES)/
s/\<fBcurs_border_set\\fP(3X)/fBborder_set\\fP(3NCURSES)/
s/\<fBcurs_clear\\fP(3X)/fBclear\\fP(3NCURSES)/
s/\<fBcurs_color\\fP(3X)/fBcolor\\fP(3NCURSES)/
s/\<fBcurs_delch\\fP(3X)/fBdelch\\fP(3NCURSES)/
s/\<fBcurs_deleteln\\fP(3X)/fBdeleteln\\fP(3NCURSES)/
s/\<fBcurs_extend\\fP(3X)/fBextensions\\fP(3NCURSES)/
s/\<fBcurs_get_wch\\fP(3X)/fBget_wch\\fP(3NCURSES)/
s/\<fBcurs_get_wstr\\fP(3X)/fBget_wstr\\fP(3NCURSES)/
s/\<fBcurs_getcchar\\fP(3X)/fBgetcchar\\fP(3NCURSES)/
s/\<fBcurs_getch\\fP(3X)/fBgetch\\fP(3NCURSES)/
s/\<fBcurs_getstr\\fP(3X)/fBgetstr\\fP(3NCURSES)/
s/\<fBcurs_getyx\\fP(3X)/fBgetyx\\fP(3NCURSES)/
s/\<fBcurs_in_wch\\fP(3X)/fBin_wch\\fP(3NCURSES)/
s/\<fBcurs_in_wchstr\\fP(3X)/fBin_wchstr\\fP(3NCURSES)/
s/\<fBcurs_inch\\fP(3X)/fBinch\\fP(3NCURSES)/
s/\<fBcurs_inchstr\\fP(3X)/fBinchstr\\fP(3NCURSES)/
s/\<fBcurs_initscr\\fP(3X)/fBinitscr\\fP(3NCURSES)/
s/\<fBcurs_inopts\\fP(3X)/fBinopts\\fP(3NCURSES)/
s/\<fBcurs_ins_wch\\fP(3X)/fBins_wch\\fP(3NCURSES)/
s/\<fBcurs_ins_wstr\\fP(3X)/fBins_wstr\\fP(3NCURSES)/
s/\<fBcurs_insch\\fP(3X)/fBinsch\\fP(3NCURSES)/
s/\<fBcurs_insstr\\fP(3X)/fBinsstr\\fP(3NCURSES)/
s/\<fBcurs_instr\\fP(3X)/fBinstr\\fP(3NCURSES)/
s/\<fBcurs_inwstr\\fP(3X)/fBinwstr\\fP(3NCURSES)/
s/\<fBcurs_kernel\\fP(3X)/fBkernel\\fP(3NCURSES)/
s/\<fBcurs_legacy\\fP(3X)/fBlegacy\\fP(3NCURSES)/
s/\<fBcurs_memleaks\\fP(3X)/fBmemleaks\\fP(3NCURSES)/
s/\<fBcurs_mouse\\fP(3X)/fBmouse\\fP(3NCURSES)/
s/\<fBcurs_move\\fP(3X)/fBmove\\fP(3NCURSES)/
s/\<fBcurs_opaque\\fP(3X)/fBopaque\\fP(3NCURSES)/
s/\<fBcurs_outopts\\fP(3X)/fBoutopts\\fP(3NCURSES)/
s/\<fBcurs_overlay\\fP(3X)/fBoverlay\\fP(3NCURSES)/
s/\<fBcurs_pad\\fP(3X)/fBpad\\fP(3NCURSES)/
s/\<fBcurs_print\\fP(3X)/fBprint\\fP(3NCURSES)/
s/\<fBcurs_printw\\fP(3X)/fBprintw\\fP(3NCURSES)/
s/\<fBcurs_refresh\\fP(3X)/fBrefresh\\fP(3NCURSES)/
s/\<fBcurs_scanw\\fP(3X)/fBscanw\\fP(3NCURSES)/
s/\<fBcurs_scr_dump\\fP(3X)/fBscr_dump\\fP(3NCURSES)/
s/\<fBcurs_scroll\\fP(3X)/fBscroll\\fP(3NCURSES)/
s/\<fBcurs_slk\\fP(3X)/fBslk\\fP(3NCURSES)/
s/\<fBcurs_sp_funcs\\fP(3X)/fBsp_funcs\\fP(3NCURSES)/
s/\<fBcurs_termattrs\\fP(3X)/fBtermattrs\\fP(3NCURSES)/
s/\<fBcurs_termcap\\fP(3X)/fBtermcap\\fP(3NCURSES)/
s/\<fBcurs_terminfo\\fP(3X)/fBterminfo\\fP(3NCURSES)/
s/\<fBcurs_threads\\fP(3X)/fBthreads\\fP(3NCURSES)/
s/\<fBcurs_touch\\fP(3X)/fBtouch\\fP(3NCURSES)/
s/\<fBcurs_trace\\fP(3X)/fBtrace\\fP(3NCURSES)/
s/\<fBcurs_util\\fP(3X)/fButil\\fP(3NCURSES)/
s/\<fBcurs_variables\\fP(3X)/fBcurses_variables\\fP(3NCURSES)/
s/\<fBcurs_window\\fP(3X)/fBwindow\\fP(3NCURSES)/
s/\<fBcurses\\fP(3X)/fBncurses\\fP(3NCURSES)/
s/\<fBdefault_colors\\fP(3X)/fBdefault_colors\\fP(3NCURSES)/
s/\<fBdefine_key\\fP(3X)/fBdefine_key\\fP(3NCURSES)/
s/\<fBform\\fP(3X)/fBform\\fP(3FORM)/
s/\<fBform_cursor\\fP(3X)/fBcursor\\fP(3FORM)/
s/\<fBform_data\\fP(3X)/fBdata\\fP(3FORM)/
s/\<fBform_driver\\fP(3X)/fBdriver\\fP(3FORM)/
s/\<fBform_field\\fP(3X)/fBfield\\fP(3FORM)/
s/\<fBform_field_attributes\\fP(3X)/fBfield_attributes\\fP(3FORM)/
s/\<fBform_field_buffer\\fP(3X)/fBfield_buffer\\fP(3FORM)/
s/\<fBform_field_info\\fP(3X)/fBfield_info\\fP(3FORM)/
s/\<fBform_field_just\\fP(3X)/fBfield_just\\fP(3FORM)/
s/\<fBform_field_new\\fP(3X)/fBfield_new\\fP(3FORM)/
s/\<fBform_field_opts\\fP(3X)/fBfield_opts\\fP(3FORM)/
s/\<fBform_field_userptr\\fP(3X)/fBfield_userptr\\fP(3FORM)/
s/\<fBform_field_validation\\fP(3X)/fBfield_validation\\fP(3FORM)/
s/\<fBform_fieldtype\\fP(3X)/fBfieldtype\\fP(3FORM)/
s/\<fBform_hook\\fP(3X)/fBhook\\fP(3FORM)/
s/\<fBform_new\\fP(3X)/fBnew\\fP(3FORM)/
s/\<fBform_new_page\\fP(3X)/fBnew_page\\fP(3FORM)/
s/\<fBform_opts\\fP(3X)/fBopts\\fP(3FORM)/
s/\<fBform_page\\fP(3X)/fBpage\\fP(3FORM)/
s/\<fBform_post\\fP(3X)/fBpost\\fP(3FORM)/
s/\<fBform_requestname\\fP(3X)/fBrequestname\\fP(3FORM)/
s/\<fBform_userptr\\fP(3X)/fBuserptr\\fP(3FORM)/
s/\<fBform_variables\\fP(3X)/fBform_variables\\fP(3FORM)/
s/\<fBform_win\\fP(3X)/fBwin\\fP(3FORM)/
s/\<fBinfocmp\\fP(1M)/fBinfocmp\\fP(1)/
s/\<fBinfotocap\\fP(1M)/fBinfotocap\\fP(1)/
s/\<fBkey_defined\\fP(3X)/fBkey_defined\\fP(3NCURSES)/
s/\<fBkeybound\\fP(3X)/fBkeybound\\fP(3NCURSES)/
s/\<fBkeyok\\fP(3X)/fBkeyok\\fP(3NCURSES)/
s/\<fBlegacy_coding\\fP(3X)/fBlegacy_coding\\fP(3NCURSES)/
s/\<fBmenu\\fP(3X)/fBmenu\\fP(3MENU)/
s/\<fBmenu_attributes\\fP(3X)/fBattributes\\fP(3MENU)/
s/\<fBmenu_cursor\\fP(3X)/fBcursor\\fP(3MENU)/
s/\<fBmenu_driver\\fP(3X)/fBdriver\\fP(3MENU)/
s/\<fBmenu_format\\fP(3X)/fBformat\\fP(3MENU)/
s/\<fBmenu_hook\\fP(3X)/fBhook\\fP(3MENU)/
s/\<fBmenu_items\\fP(3X)/fBitems\\fP(3MENU)/
s/\<fBmenu_mark\\fP(3X)/fBmark\\fP(3MENU)/
s/\<fBmenu_new\\fP(3X)/fBnew\\fP(3MENU)/
s/\<fBmenu_opts\\fP(3X)/fBopts\\fP(3MENU)/
s/\<fBmenu_pattern\\fP(3X)/fBpattern\\fP(3MENU)/
s/\<fBmenu_post\\fP(3X)/fBpost\\fP(3MENU)/
s/\<fBmenu_requestname\\fP(3X)/fBrequestname\\fP(3MENU)/
s/\<fBmenu_spacing\\fP(3X)/fBspacing\\fP(3MENU)/
s/\<fBmenu_userptr\\fP(3X)/fBuserptr\\fP(3MENU)/
s/\<fBmenu_win\\fP(3X)/fBwin\\fP(3MENU)/
s/\<fBmitem_current\\fP(3X)/fBmenu_current\\fP(3MENU)/
s/\<fBmitem_name\\fP(3X)/fBmenu_name\\fP(3MENU)/
s/\<fBmitem_new\\fP(3X)/fBmenu_new\\fP(3MENU)/
s/\<fBmitem_opts\\fP(3X)/fBmenu_opts\\fP(3MENU)/
s/\<fBmitem_userptr\\fP(3X)/fBmenu_userptr\\fP(3MENU)/
s/\<fBmitem_value\\fP(3X)/fBmenu_value\\fP(3MENU)/
s/\<fBmitem_visible\\fP(3X)/fBmenu_visible\\fP(3MENU)/
s/\<fBncurses\\fP(3X)/fBncurses\\fP(3NCURSES)/
s/\<fBnew_pair\\fP(3X)/fBnew_pair\\fP(3NCURSES)/
s/\<fBpanel\\fP(3X)/fBpanel\\fP(3CURSES)/
s/\<fBprintf\\fP(3S)/fBprintf\\fP(3)/
s/\<fBputc\\fP(3S )/fBputc\\fP(3)/
s/\<fBresizeterm\\fP(3X)/fBresizeterm\\fP(3NCURSES)/
s/\<fBscanf\\fP(3S)/fBscanf\\fP(3)/
s/\<fBscr_dump\\fP(5)/fBscr_dump\\fP(5)/
s/\<fBsystem\\fP(3S)/fBsystem\\fP(3)/
s/\<fBtabs\\fP(1)/fBtabs\\fP(1)/
s/\<fBterm\\fP(5)/fBterm\\fP(5)/
s/\<fBterm\\fP(7)/fBterm\\fP(7)/
s/\<fBterm_variables\\fP(3X)/fBterminfo_variables\\fP(3NCURSES)/
s/\<fBterminfo\\fP(5)/fBterminfo\\fP(5)/
s/\<fBterminfo\\fP(\\\*N)/fBterminfo\\fP(5)/
s/\<fBtic\\fP(1M)/fBtic\\fP(1)/
s/\<fBtoe\\fP(1M)/fBtoe\\fP(1)/
s/\<fBtput\\fP(1)/fBtput\\fP(1)/
s/\<fBtset\\fP(1)/fBtset\\fP(1)/
s/\<fBuser_caps\\fP(5)/fBuser_caps\\fP(5)/
s/\<fBwresize\\fP(3X)/fBwresize\\fP(3NCURSES)/
s/\<fBgetty\\fP(1)/fBgetty\\fP(8)/
s/\<fBscanf\\fP(3)/fBscanf\\fP(3)/
s/\<fBttys\\fP(5)/fBttys\\fP(4)/
s/\<fBsystem\\fP(3)/fBsystem\\fP(3)/
s/\<fBregcomp\\fP(3X)/fBregcomp\\fP(3)/
s/\<fBregexec\\fP(3X)/fBregexec\\fP(3)/
s/\<fBvprintf\\fP(3)/fBvprintf\\fP(3)/
s/\<fBadacurses6-config\\fP(1)/fBadacurses6-config\\fP(1)/
s/\<fBncurses6-config\\fP(1)/fBncurses6-config\\fP(1)/
