...
if test "$form" = normal ; then
	if test "no" = yes ; then
	if test "no" = no ; then
		/bin/bash "$0" format "$verb" "$mandir" "$srcdir" "$@"
		exit 0
	fi
	fi
...
(*.[0-9]*)
	...
	if test ! -f "/home/jee/linux/armv7/ll/buildroot/output/build/host-ncurses-6.4-20230429/man_alias.sed" ; then
cat >>/home/jee/linux/armv7/ll/buildroot/output/build/host-ncurses-6.4-20230429/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/jee/linux/armv7/ll/buildroot/output/build/host-ncurses-6.4-20230429/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$cf_full_alias" |sed -f "/home/jee/linux/armv7/ll/buildroot/output/build/host-ncurses-6.4-20230429/man_alias.sed" | sort -u; test "$cf_part_alias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/jee/linux/armv7/ll/buildroot/output/build/host-ncurses-6.4-20230429/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/jee/linux/armv7/ll/buildroot/output/build/host-ncurses-6.4-20230429/man_alias.sed" \
		< "$i" | sed -f /home/jee/linux/armv7/ll/buildroot/output/build/host-ncurses-6.4-20230429/edit_man.sed >$TMP
